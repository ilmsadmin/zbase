...
import { MessageCircle, Construction, Facebook, AlertTriangle } from 'lucide-react';
        ...
        {!isLoading && !isConnected && (
          <Alert variant="warning" className="mb-6">
            ...
            <AlertDescription className="flex items-center justify-between">
              <span>Your Facebook account is not connected. You need to connect it to manage comments.</span>
              <Button 
                variant="outline" 
                size="sm" 
                className="ml-4"

...
import { FiEdit, FiTrash2, FiArrowLeft, FiUser, FiMail, FiPhone, FiMapPin, FiTag } from 'react-icons/fi';
...
// Define Order interface for customer orders
interface Order {
  id: number;
  code: string;
  date: string;
...
// Define Transaction interface for customer transactions
...
export default function CustomerDetailPage({ params }: PageProps) {
  ...
  // Define order columns for the orders tab
  ...
  const transactionColumns: Column<Transaction>[] = [
    ...
    },
    {
      ...
      render: (row) => (
        <span className={`px-2 py-1 text-xs font-medium rounded-full 
          ${row.type === 'payment' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
        >
          {row.type}
        </span>
      ),
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="p-6 border-b border-gray-200 flex flex-wrap justify-between items-center">
            <div className="flex items-center mb-2 md:mb-0">
              ...
              <FiUser size={24} className="text-primary mr-2" />
          ...
          <div className="border-b border-gray-200">
            <nav className="flex -mb-px">
              ...
              <button
                ...
                className={`py-4 px-6 ${activeTab === 'orders'
                  ? 'border-b-2 border-primary text-primary'
                  : 'text-gray-500 hover:text-gray-700 hover:border-gray-300'
                  }`}
              >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{customer.phone || t('notSpecified')}</div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{customer.email || t('notSpecified')}</div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{customer.address || t('notSpecified')}</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="text-sm text-gray-500">{t('fields.group')}</div>
                        <div className="font-medium">
                          {customer.group ? (
                            <Link href={`/admin/customer-groups/${customer.group.id}`} className="text-primary hover:underline">
                              {customer.group.name}
                            </Link>
                          ) : (
                            t('notSpecified')
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{customer.notes || t('noNotes')}</div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <div className="mt-1 mr-3 text-gray-500">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{formatDateTime(customer.updatedAt)}</div>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'orders' && (
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-semibold">{t('tabs.orders')}</h2>
                  <Link href={`/admin/invoices/new?customerId=${customer.id}`}>
                    <button className="px-3 py-2 text-sm font-medium text-white bg-primary rounded-md hover:bg-primary-dark">
                      <FiPlus className="inline mr-2" /> {t('orders.create')}
                    </button>
                  </Link>
                </div>
                ...
                {customer.orders && customer.orders.length > 0 ? (
                  <DataTable
                    ...
                    exportable
                    exportFilename={`customer-${customer.id}-orders`}
                  />
                ) : (
            ...
            {activeTab === 'transactions' && (
              <div>
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Link href={`/admin/transactions/new?customerId=${customer.id}`}>
                    <button className="px-3 py-2 text-sm font-medium text-white bg-primary rounded-md hover:bg-primary-dark">
                ...
                {customer.transactions && customer.transactions.length > 0 ? (
                  <DataTable
                    ...
                    exportable
                    exportFilename={`customer-${customer.id}-transactions`}
                  />
                ) : (
                  <div className="bg-gray-50 p-8 text-center rounded-lg">
